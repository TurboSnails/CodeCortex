...
import { mergeEnvelope, useTypewriterEnvelopes } from "../components/chat/useRunChat";
import { computeTokens, TokenMeter } from "../components/chat/TokenMeter";

// ── Transcript → envelope conversion (Run.tsx-specific) ───────────────
...
function RunSession(props: RunSessionProps) {
  ...
  const init = useMemo(
    () => props.envelopes.find((e) => e.type === "system") as SystemInitEnvelope | undefined,
    [props.envelopes]
  );
